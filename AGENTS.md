...
**第2次領藥（serno2 為空）**：
- 第2次建議日 = 第1次 + (per_days - 8)
- 第3次建議日 = 第1次 + (per_days*2 - 8)
- 只回覆效期，不做效期檢查

**第3次領藥（serno3 為空）**：
- 回覆前兩次實際領藥日期
- 偵測第2次是否延後領藥（實際 > 建議）
- 延後領藥：第3次建議日 = 第2次實際 + (per_days - 8)
- 未延後：第3次建議日 = 第1次 + (per_days*2 - 8)
- 效期檢查：
  - 效期 < 建議區間最小日 → 回報「第3次已過期，請回診」
  - 效期在區間內 → 建議區間改為「最小日 ~ 效期日」
  - 效期 > 區間最大日 → 沒問題
...
第2次領藥：2026/05/31（已領）
第3次建議領藥區間：2026/06/28-2026/07/28
...
第3次建議領藥區間：2026/07/02-2026/07/28
